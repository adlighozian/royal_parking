            ...
            @foreach ($parkiran as $parkiran)
                <div class="col-md-4 mb-3">
                    <div class="card">
                        ...
                        <a href="/booking/{{ $parkiran->slug }}" class="text-decoration-none">
                            <img class="card-img-top" src="https://source.unsplash.com/500x400?{{ $parkiran->gambar }}"
                                alt="{{ $parkiran->gambar }}">
                        </a>
                        <div class="card-body">
                            <h5 class="card-title"> <a href="/booking/{{ $parkiran->slug }}"
                                    class="text-decoration-none">
                                    {{ $parkiran->nama }} </a></h5>

                            <p class="card-text">{{ $parkiran->nama }}</p>
                            <a href="/booking/{{ $parkiran->slug }}" class="text-decoration-none btn btn-primary">Booking
                                now </a>
                        </div>
                    </div>
                </div>
